...
5. [docs/05-디버깅.md](docs/05-디버깅.md) — 에러 라벨·OOM 의 정체·역추적 — 이론을 실전 진단으로 잇는 장.

그다음 **직접 손으로** 해 보세요:

6. [docs/labs/](docs/labs/README.md) — 실습 랩 6종: 바이너리 직접 실행 · venv+pip+requirements · uv · poetry · conda · 웹 배포. (터미널·명령어 개념부터, 코딩 처음을 가정)
7. [slides/](slides/index.html) — 위 문서 5편 + 실습 6종을 한 편으로 엮은 강의 슬라이드(HTML).
...
├── docs/                     # 읽는 문서 (마크다운)
│   ├── 01~05 *.md            # CS 기초 · Python 환경 · 문법 · 언어 비교 · 디버깅
│   └── labs/                 # 실습 랩 6종 + 안내
